			        ...
			        <div class="card-content ">
						...
						<form action="#" method="post" enctype="multipart/form-data">
							...
							<div class="row">
								...
								<div class="input-field col s12">
									<textarea id="textarea" class="materialize-textarea" name="question" required></textarea>
									<label for="question">Assignment Question, and Instructions</label>
								</div>

								<div class="input-field col s12">
									<input id="number" type="number" class="materialize-textarea" name="marks">
								...
								<div class="input-field col s12">
									...
									<?php 
										...
										while($row2  =$get_sub->fetch_assoc()){
											...
											$sub_name_q=$db->query("SELECT * FROM subjects WHERE id = '$sub_id' ");
