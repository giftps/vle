        <nav class="navbar navbar-expand navbar-light sidebar_new_bg topbar mb-4 static-top shadow">
          ...
          <form action="../search/search.php" method="GET" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
            <div class="input-group">
              <input type="text" name="query" class="form-control bg-light border-0 small" placeholder="Search for student's name, id, house parent etc..." aria-label="Search" aria-describedby="basic-addon2">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-white small"><strong> <?php echo "$username"; ?></strong></span>
                <img class="img-profile rounded-circle" src="../assets/profile-pic.jpg">
              </a>
              <!-- Dropdown - User Information -->
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">

                <?php if(isset($id))  { // ADD EDIT PROFILE ON HOMEPAGE WHERE ID IS AVAILABLE ?>
                  <a class="dropdown-item" href="../update_profile.php?id=<?php echo $id;?>">
