                                                ...
                                                while($row_loop = mysqli_fetch_assoc($result_loop)){        
                                                    ...
                                                    while($grades_row = mysqli_fetch_assoc($grades_res)){
                                                        ...
                                                        if ( in_array($value, range($min,$max)) ) {
                                                            echo $grade = "<td>".$grades_row['name']."</td>";
                                                    ...
                                                    echo "<td>".$row_loop['comment']."</td>";
                                                }
                                            }
                                        }
                                    }
                                    echo"<td> <a href='../../reports/student_grades_report.php?name=$results_name&stud_id=$student_id'>Report</a> <td>";
