<?php 
    require_once('../../../config/student_server.php');   //contains db connection so we good 🤦🏾‍♂️
    $add_side_bar = true;
                ...
                <div class="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5">
                            ...
                            <?php 
                                $q_results = "SELECT  name, id,date FROM results WHERE id = '$id' GROUP BY name ";
                        ...
                        <div class="text-right text-white">
                            ...
                            <a href="../../../config/admin_server.php?id=<?php echo $id;?>&delete_student=true" class="btn btn-danger btn-sm">Delete</a>
                        </div>
                        </div>
