...
<body>
    ...
    <div class="text-right text-light col-md-12">
        <br>
        <div class="btn-group">
            <button class="btn btn-sm btn-info" onclick="location.href='../accountant/fees/index.php';">Back </i> </button>
    ...
    <div class="container"  id="print_it">
        ...
        <form id="contactus" action="" method="post" >
            ...
            <!-- Get Payment -->
            <div class="text-center text-info"><h2> Tuition Payment Reciept </h2></div>
            <br><br>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            ...
                            while($payments_row  = mysqli_fetch_assoc($payments_query) ){
                                $student_id = $payments_row['student_id'];
                                $term = $payments_row['term'];
                                $year = $payments_row['year'];
                                ...
                                /**Get studen */
                                $q = "SELECT name FROM students WHERE id = '$student_id' ";
                                ...
                                echo "<p> <b>$student_name </b> has on <b> $date_paid </b> paid the sum of <b> $currency ". number_format($amount_paid, 2) ." </b><b> $payment_method </b>
                                        towards <b> term $term, $year tuition fees </b> </p>";
