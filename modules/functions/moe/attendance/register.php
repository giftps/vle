                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="student_register" width="100%" cellspacing="">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <?php 
                                                        $query = "SELECT  name,id,username FROM students WHERE class_id = '$class_id'";
                                                    ...
                                                    <td>
                                                        <div class="custom-control">                                                            
                                                            <input type="checkbox" name="attendance[]" value="Present" id="<?php echo $student_id ?>" />
                                                            <label class="btn btn-sm btn-outline-success" for="<?php echo $student_id ?>">Present</label>
                                                                        
                                                            <input type="checkbox" name="attendance[]" value="Absent" id="<?php echo $username; ?>" />
                                                            ...
                                                            <?php //$var = "<script>alert(NameValue);</script>";var_dump($abc); ?> -->
                                                        </div>
                                                    </td>
                                                </tr>
                                                    <?php
