<?php 
    require_once('../scripts/accountant_validation.php');
...
?>
        ...
        <?php 
            ...
            if (mysqli_num_rows($result) > 0){  
                $images_dir = "../../../utils/images/accountants/";
            ...
            <div class="container-fluid col-md-9">
                ...
                <div class="card mb-4">
                    <div class=" card-header text-center">
                        <h3 class="text-">Accountants Info</h3>
                        <div class="text-">
                    ...
                    <div class="row">
                            ...
                            <div class="col-lg-5">
                                ...
                                <div class="text-right text-white">
                                    <a href="update_accountant.php?id=<?php echo $accountant_id ?>" class="btn btn-info btn-sm">Edit</a>
                                    <a href="../../../config/admin_server.php?id=<?php echo $accountant_id;?>&delete_accountant=true" class="btn btn-danger btn-sm">Delete</a>
                                </div>
                            </div>
