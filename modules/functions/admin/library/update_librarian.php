...
<hr/> 
        <?php 
            $query = "SELECT  * from librarians where id = '$librarian_id' ";
            ...
            <div class="container-fluid col-md-9">
                <div class="card mb-4">
                    <div class="card-header text-center">
                        <h3>Update Librarian's Info</h3>
                    </div>
                    <div class="card-body">
                        <form action="update_librarian.php" method="POST" enctype="multipart/form-data">
                            ...
                            <table class="table" id="dataTable" width="100%" cellspacing="9">
                                ...
                                <tr>
                                    <td></td>
                                    <td class="text-left"><input class="btn btn-sm btn-secondary " type="submit" name="update_librarian" value="Submit"></td>
                                </tr>
                            </table>
                        </form>
                    </div>
