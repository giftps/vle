        ...
        <main>
                <div class="card mb-4">
                    <div class=" card-header text-center">
                        <h3 class="text-">Managers Info</h3>
                        <div class="text-">
                    ...
                    <div class="row">
                            ...
                            <div class="col-lg-5">
                                ...
                                <div class="text-right text-white">
                                    <a href="update_manager.php?id=<?php echo $manager_id ?>" class="btn btn-info btn-sm">Edit</a>
                                    <a href="../../../config/admin_server.php?id=<?php echo $manager_id;?>&delete_manager=true" class="btn btn-danger btn-sm">Delete</a>
                                </div>
                            </div>
